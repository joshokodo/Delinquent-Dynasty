...
// TODO: maybe add mental to watch content function types
[UpdateInGroup(typeof(ActionsGroup))]
[BurstCompile]
public partial struct WatchContentOnPhoneSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.WATCH_CONTENT_ON_ELECTRONIC), 0);
        _triggerEffects.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.WATCH_CONTENT_ON_ELECTRONIC), 1);
    }

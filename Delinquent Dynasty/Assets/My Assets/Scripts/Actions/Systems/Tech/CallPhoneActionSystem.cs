...
public partial struct CallPhoneActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsEyesActionFunction>(ref state, new DynamicActionType(CommonTechActionType.CALL_PHONE), 0);
        _triggerEffects.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.CALL_PHONE), 1);
    }

...
[BurstCompile]
public partial struct DownloadAppActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.DOWNLOAD_APP),
            0);
        _triggerEffects.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.DOWNLOAD_APP), 1);
    }

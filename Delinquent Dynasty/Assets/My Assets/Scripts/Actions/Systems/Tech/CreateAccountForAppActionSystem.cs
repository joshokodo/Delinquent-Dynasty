...
[BurstCompile]
public partial struct CreateAccountForAppActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.CREATE_ACCOUNT_FOR_APP), 0);
        _triggerEffects.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonTechActionType.CREATE_ACCOUNT_FOR_APP), 1);
    }

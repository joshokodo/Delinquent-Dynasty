...
[BurstCompile]
public partial struct WashHandsActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsActionFunction>(ref state, new DynamicActionType(MiscActionType.WASH_HANDS), 0);
        _triggerEffects.SetUp<ArmsActionFunction>(ref state, new DynamicActionType(MiscActionType.WASH_HANDS), 1);
    }

...
[BurstCompile]
public partial struct TurnOnElectronicSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsEyesActionFunction>(ref state, new DynamicActionType(CommonItemActionType.TURN_ON_ELECTRONIC), 0);
        _triggerEffects.SetUp<ArmsEyesActionFunction>(ref state,
            new DynamicActionType(CommonItemActionType.TURN_ON_ELECTRONIC), 1);
    }

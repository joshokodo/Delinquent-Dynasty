...
[BurstCompile]
public partial struct CreateAssignmentDocumentActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<ArmsEyesMentalActionFunction>(ref state, new DynamicActionType(CommonItemActionType.CREATE_ASSIGNMENT_DOCUMENT),
            0);
        _triggerEffects.SetUp<ArmsEyesMentalActionFunction>(ref state,
            new DynamicActionType(CommonItemActionType.CREATE_ASSIGNMENT_DOCUMENT), 1);
    }

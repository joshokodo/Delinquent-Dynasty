...
[BurstCompile]
public partial struct BrawlAttackActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _moveToTarget.SetUp<ArmsEyesLegsMentalActionFunction>(ref state,
            new DynamicActionType(FightingActionType.BRAWL_ATTACK), 0);
        _triggerEffects.SetUp<ArmsEyesLegsMentalActionFunction>(ref state,
            new DynamicActionType(FightingActionType.BRAWL_ATTACK), 1);
    }

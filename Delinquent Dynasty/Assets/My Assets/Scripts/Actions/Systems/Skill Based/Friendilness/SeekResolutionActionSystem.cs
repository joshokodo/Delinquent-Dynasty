...
[BurstCompile]
public partial struct SeekResolutionActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.SEEK_RESOLUTION), 0);
        _triggerEffects.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.SEEK_RESOLUTION), 1);
    }

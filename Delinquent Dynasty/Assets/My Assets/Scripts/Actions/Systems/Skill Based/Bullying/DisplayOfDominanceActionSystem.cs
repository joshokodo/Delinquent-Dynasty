...
[BurstCompile]
public partial struct DisplayOfDominanceActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.DISPLAY_OF_DOMINANCE), 0);
        _triggerEffects.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.DISPLAY_OF_DOMINANCE), 1);
    }

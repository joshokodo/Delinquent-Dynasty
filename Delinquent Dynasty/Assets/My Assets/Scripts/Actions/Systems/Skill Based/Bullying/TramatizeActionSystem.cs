...
[BurstCompile]
public partial struct TramatizeActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.TRAMATIZE), 0);
        _triggerEffects.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.TRAMATIZE), 1);
    }

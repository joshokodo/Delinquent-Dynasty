...
[BurstCompile]
public partial struct HostileChatActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.HOSTILE_CHAT), 0);
        _triggerEffects.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(SkillBasedSocialActionType.HOSTILE_CHAT), 1);
    }

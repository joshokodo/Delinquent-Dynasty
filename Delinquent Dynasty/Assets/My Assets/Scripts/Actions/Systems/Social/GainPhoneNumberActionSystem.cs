...
[BurstCompile]    
public partial struct GainPhoneNumberActionSystem : ISystem {
 private PerformActionUtil _perform;
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_PHONE_NUMBER_KNOWLEDGE), 0);
        _triggerInfluenced.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_PHONE_NUMBER_KNOWLEDGE), 1);
    }

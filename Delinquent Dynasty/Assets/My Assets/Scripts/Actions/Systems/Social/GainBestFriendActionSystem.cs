...
[BurstCompile]
public partial struct GainBestFriendActionSystem : ISystem {
 private PerformActionUtil _perform;
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_BEST_FRIEND), 0);
        _triggerInfluenced.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_BEST_FRIEND), 1);
    }

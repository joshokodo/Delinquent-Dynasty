...
[BurstCompile]
public partial struct GainWellnessKnowledgeActionSystem : ISystem {
 private PerformActionUtil _perform;
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_WELLNESS_KNOWLEDGE), 0);
        _triggerInfluenced.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_WELLNESS_KNOWLEDGE), 1);
    }

...
[BurstCompile]
public partial struct GainTraitKnowledgeActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        ...
        _perform.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_TRAIT_KNOWLEDGE), 0);
        _triggerInfluenced.SetUp<MentalMouthActionFunction>(ref state,
            new DynamicActionType(CommonSocialActionType.GAIN_TRAIT_KNOWLEDGE), 1);
    }

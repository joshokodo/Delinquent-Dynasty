...
[BurstCompile]
public partial struct OpenBusinessActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        _actionType = new DynamicActionType(CommonItemActionType.OPEN_BUSINESS);
    ...
    public void OnUpdate(ref SystemState state){
        ...
        _perform.StateChangeSpawn = stateChangeSpawnElements;

...
[BurstCompile]
public partial struct LockSecurityLockActionSystem : ISystem {
    ...
    public void OnCreate(ref SystemState state){
        _actionType = new DynamicActionType(CommonItemActionType.LOCK_SECURITY_LOCK);
    ...
    public void OnUpdate(ref SystemState state){
        ...
        var h2 = new LockSecurityLockMainThreadJob(){
            DynamicActionType = _actionType,
            Ecb = ecb,
...
[BurstCompile]
public partial struct LockSecurityLockMainThreadJob : IJobEntity {
